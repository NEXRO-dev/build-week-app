  ...
  return (
    <div>
      ...
      <div className="space-y-5 px-4 pb-8 pt-4">
        ...
        <section><h2 className="mb-2 text-xs font-bold text-[#4e3ad0]">{t("データとプライバシー", "Data & privacy")}</h2><div className="divide-y divide-[#ececf3] rounded-lg border border-[#e3e5ef]"><Row icon={Database} title={t("音声データの保存", "Audio storage")} description={t("処理後に削除（推奨）", "Delete after processing (recommended)")} /><Row icon={Database} title={t("音声データの削除", "Delete audio data")} description={t("すべての音声データを削除します", "Delete all stored audio data")} /></div></section>
